...
const TermsAndConditions = () => (
  <LegalLayout title="Términos y Condiciones">
    ...
    <h2>1. Objeto</h2>
    <p>Los presentes términos regulan el acceso y uso de los productos digitales ofrecidos por <strong>Glowth Agency</strong>, así como la compra de los mismos.</p>
    ...
    <p>Todo el contenido (textos, imágenes, materiales) es propiedad de Glowth Agency. Queda prohibida su reproducción, distribución o reventa sin autorización expresa.</p>
